...
namespace Demo.Controllers
{
    public class HotelController : ApiController
    {
        ...
        //           string Url = "https://maps.googleapis.com/maps/api/place/nearbysearch/xml?location="+latString+","+longiString+"&radius=15000&type=hotels&keyword=cruise&key=AIzaSyCEYBTJaRPGz2e-wq-u3aoEOTI6w-DtQ7A";
